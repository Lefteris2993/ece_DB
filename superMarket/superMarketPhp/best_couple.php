        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="page-header clearfix">
                        <h2 class="pull-left">Top 5 couples</h2>
                    </div>
                    <?php
                    // Include config file
                    ...
                    $sql = "SELECT f.aName, product.name as bName, f.aBar, f.bBar, f.total FROM product,  
                    (SELECT product.name as aName, e.aBar, e.bBar, e.total FROM product,
                    (SELECT *, COUNT(*) as total, aBar + bBar as sum FROM
                    (SELECT * FROM
                    (SELECT a.purchaseID as aID, b.purchaseID as bID, a.barcode as aBar, b.barcode as bBar FROM contains as a , contains as b) as c
                    WHERE aID = bID and aBar != bBar) as d GROUP BY aBar, bBar) as e
                    WHERE product.barcode = e.aBar
                    GROUP BY sum) as f
                    WHERE product.barcode = f.bBar
                    ORDER BY total DESC 
                    LIMIT 5";
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                echo "<tr>";
                                    echo "<th>Name 1</th>";
                                    echo "<th>Name 2</th>";
                                    echo "<th>Barcode 1</th>";
                                    echo "<th>Barcode 2</th>";
