        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="page-header clearfix">
                        <h2 class="pull-left">Products in <?php
                    require_once "config.php";
                    $categoryID =  trim($_GET["categoryID"]);
                    $sql = "SELECT catType from category where categoryID = $categoryID ";
                    ...
                    ?> </h2>
                    <a href="categories.php" class="btn btn-success pull-right" 
                    ...
                    if(isset($_GET["categoryID"]) && !empty($_GET["categoryID"])){
                        $categoryID =  trim($_GET["categoryID"]);
                        $sql = "SELECT name, barcode, price FROM product WHERE product.categoryID=$categoryID ";
                        if($result = mysqli_query($link, $sql)){
