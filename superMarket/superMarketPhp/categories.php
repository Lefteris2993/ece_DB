        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="page-header clearfix">
                        <h2 class="pull-left">category types</h2>
                        <a href="create_category.php" class="btn btn-success pull-right" 
                        style="background-color: #337ab7; border-color: #337ab7;color:white;width:auto;
                        height:auto;">Add New category</a>
                    </div>
                    <?php
                    // Include config file
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                        ...
                                        echo "<td>";
                                            echo "<a href='edit_category.php?categoryID=". $row['categoryID'] ."' title='edit Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                            echo "<a href='delete_category.php?categoryID=". $row['categoryID'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                            echo "<a href='peek_category.php?categoryID=". $row['categoryID'] ."' title='view products' data-toggle='tooltip'><span class='glyphicon glyphicon-zoom-in'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
