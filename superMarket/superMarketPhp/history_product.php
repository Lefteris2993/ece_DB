        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="page-header clearfix">
                        ...
                        <a href="products.php" class="btn btn-success pull-right" 
                    ...
                    if(isset($_GET["barcode"]) && !empty($_GET["barcode"])){
                        ...
                        $sql = "SELECT priceHistory.startDate, priceHistory.price FROM priceHistory WHERE priceHistory.barcode=$barcode ORDER BY priceHistory.startDate DESC";
