...
if(isset($_POST["cardID"]) && !empty($_POST["cardID"])){
    ...
    $sql = "DELETE FROM customer WHERE cardID = ?";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            <input type="hidden" name="cardID" value="<?php echo trim($_GET["cardID"]); ?>"/>
                            <p>Are you sure you want to kick this customer?</p><br>
                            <p>
