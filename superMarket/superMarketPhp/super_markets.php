        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="page-header clearfix">
                        <h2 class="pull-left">Super Markets</h2>
                        <a href="add_market.php" class="btn btn-success pull-right" 
                        style="background-color: #337ab7; border-color: #337ab7;color:white;width:auto;
                        height:auto;">Add New Market</a>
                    </div>
                    <?php
                    // Include config file
                         ...
                         if(mysqli_num_rows($result) > 0){
                             echo "<table class='table table-bordered table-striped'>";
                                 ...
                                 while($row = mysqli_fetch_array($result)){
                                         ...
                                         echo "<td>" . $row['sqrMeters'] . "</td>";
                                         echo "<td>";
                                             echo "<a href='edit_market.php?marketID=". $row['marketID'] ."' title='edit Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                             echo "<a href='delete_market.php?marketID=". $row['marketID'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                         echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
