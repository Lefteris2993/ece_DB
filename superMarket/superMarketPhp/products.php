        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="page-header clearfix">
                    ...
                    $sql = "SELECT * FROM product,category WHERE product.categoryID = category.categoryID";

                    //$catype = "SELECT * FROM `product`,category WHERE product.categoryID = category.categoryID";
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                        ...
                                        if ($row['labeled'] == 0){ echo "<td>" . "No". "</td>";}
                                        else { echo "<td>" . "Yes". "</td>";}
                                        echo "<td>";
                                            echo "<a href='edit_product.php?barcode=". $row['barcode'] ."' title='edit Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                            echo "<a href='delete_product.php?barcode=". $row['barcode'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                            echo "<a href='history_product.php?barcode=". $row['barcode'] ."' title='view price history' data-toggle='tooltip'><span class='glyphicon glyphicon-header'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
